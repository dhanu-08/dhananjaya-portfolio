...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    // Always open the project details page at the top
    ...
    const loadProject = async () => {
      ...
      try {
        ...
        // Force page to top after project data loads
        setTimeout(() => {
          window.scrollTo({
            top: 0,
            left: 0,
    ...
    return (
      <div className="min-h-screen bg-[#030014] flex items-center justify-center px-6">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate(-1)}
            className="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium hover:scale-105 transition-transform"
          >
            Go Back
          </button>
        </div>
  ...
  return (
    <>
      ...
      <Helmet>
        <title>{project.Title} — Dhananjaya Meher</title>
        ...
        <meta
          ...
          content={
            project.Description
              ...
              : `Project ${project.Title} by Dhananjaya Meher.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Dhananjaya Meher`}
        />
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
              ...
              <div className="space-y-6 md:space-y-10 animate-slideInRight">
                ...
                <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl group min-h-[250px]">
