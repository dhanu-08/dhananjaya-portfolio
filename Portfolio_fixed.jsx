...
/\* Finance / Banking related skills \*/
...
          Explore my projects, certifications, and technical

          skills as I continue developing my knowledge in finance,

          banking, business analytics, and technology.
...
      className="group w-56 h-56 rounded-3xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 border border-indigo-400/20 hover:border-indigo-400/60 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-indigo-500/20 flex flex-col items-center justify-center"
